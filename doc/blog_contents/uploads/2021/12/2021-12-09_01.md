...
![A-Beginner-Guide-To-Blazor-Server-and-WebAssembly-Applications](https://img1.lequ.co/2021/12/cover_04.png)
...
![BLAZOR](https://img1.lequ.co/2021/12/0401.png)
...
![WebAssembly](https://img1.lequ.co/2021/12/0402.png)
...
![Blazor-Server-Apps](https://img1.lequ.co/2021/12/0403.png)
...
![Blazor-WebAssembly-Apps](https://img1.lequ.co/2021/12/0404.png)
...
![Create-New-Blazor-App-Project-in-Visual-Studio-2019](https://img1.lequ.co/2021/12/0405.png)
...
![Blazor-Server-App-in-Visual-Studio-2019](https://img1.lequ.co/2021/12/0406.png)

Visual Studio 将为我们创建一个 Blazor Server 应用程序，其中在解决方案资源管理器中包含以下文件夹和文件。

![Blazor-Server-App-in-Solution-Explorer](https://img1.lequ.co/2021/12/0407.png)
...
![Default-Blazor-Server-App-Running-in-Browser](https://img1.lequ.co/2021/12/0408.png)

您也可以打开浏览器开发者工具，您会注意到所有标准的 CSS 和 JavaScript 文件（包括 blazor.server.js 文件）都下载到了客户端，并通过 Web Sockets 建立了一个 SignalR 连接。

![Blazor-Server-App-Files-in-Browser-Developer-Tools](https://img1.lequ.co/2021/12/0409.png)
...
![Create-Blazor-WebAssembly-App-in-Visual-Studio-2019](https://img1.lequ.co/2021/12/0410.png)

Visual Studio 将为我们创建一个 Blazor WebAssembly 应用程序，其中在解决方案资源管理器中包含以下文件夹和文件。

![Blazor-Client-App-in-Solution-Explorer](https://img1.lequ.co/2021/12/0411.png)
...
![Default-Blazor-Server-App-Running-in-Browser](https://img1.lequ.co/2021/12/0412.png)

正如我们已经知道的那样，Blazor WebAssembly 应用程序会在客户端下载应用程序及其所有依赖项，因此如果您打开浏览器开发者工具，会看到客户端下载了大量 DLL（只会在第一次浏览时下载）。

![Blazor-Client-App-Files-in-Browser-Developer-Tools](https://img1.lequ.co/2021/12/0413.png)

以上所有文件只会在第一次请求时下载，然后它们被缓存在浏览器中。如果您再次刷新页面，将会看到这一次下载的文件很少。

![Blazor-Client-App-Files-in-Browser-Developer-Tools-Second-Request](https://img1.lequ.co/2021/12/0414.png)
