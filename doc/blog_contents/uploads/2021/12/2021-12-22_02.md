...
![](https://img1.lequ.co/2021/12/3201.png)

在`BlazorServer` 项目按右键，选择「`添加`」，选择「`新搭建基架的项目`」，切换到「`标识`」页签，选择`标识`。

![](https://img1.lequ.co/2021/12/3202.png)

![](https://img1.lequ.co/2021/12/3203.png)
...
![](https://img1.lequ.co/2021/12/3208.png)

项目则多了一个`Areas` 文件夹，里面就是`ASP.NET Core Identity` 的实现，包括了`登录系统`、`帐号系统`、`管理系统`。

![](https://img1.lequ.co/2021/12/3209.png)
...
![](https://img1.lequ.co/2021/12/3210.gif)

注册界面填写正确的邮箱和密码，`AspNetUsers`表即可查看注册的用户信息：

![](https://img1.lequ.co/2021/12/3211.png)
...
>作者：StrayaWorker
>
>原文链接：https://ithelp.ithome.com.tw/articles/10268982
>
>编辑：沙漠尽头的狼
