...
{
    public class LinkForCreationDtoValidator : AbstractValidator<LinkForCreationDto>
    {
        public LinkForCreationDtoValidator(IStringLocalizer<LinkForCreationDtoValidator> localizer)
        {
            RuleFor(x => x.Name)
