      ...
      <Dropdown overlayClassName={classNames(styles.userDropdown)} overlay={
        <Menu>
          {globalConfig.development && <Menu.Item>
            <a href="http://localhost:8299/_codegen?ui=react" target="_blank">  <Icon type='code' /> <FormattedMessage id='action.user.codeGenerator' /></a>
          </Menu.Item>}
          {globalConfig.development && <Menu.Item>
            <a href="http://localhost:8299/swagger" target="_blank">  <Icon type='bars' /> <FormattedMessage id='action.user.apiDocument' /></a>
          </Menu.Item>}
          <Menu.Item>
            <DialogForm
